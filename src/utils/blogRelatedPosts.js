...
/** Product pages to surface on matching blog posts (internal linking). */
...
/** Product/feature CTA for a blog post, if one applies. */
...
/**
 * Pick related posts from the same topical cluster, preserving pillar order.
 * Falls back to the listing cluster, then newest posts.
 */
