...
const BANNER_HEIGHT = 120; // Height of the banner area including nav and token banner
const TOP_PADDING = BANNER_HEIGHT + 20; // Additional padding from top to account for banner
