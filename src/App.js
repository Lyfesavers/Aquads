...
const BANNER_HEIGHT = 5; // Height of the banner area including nav and token banner
const TOP_PADDING = BANNER_HEIGHT + 2; // Additional padding from top to account for banner
