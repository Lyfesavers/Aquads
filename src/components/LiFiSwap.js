...
const LiFiSwap = ({ currentUser, showNotification }) => {
  ...
  const renderWidget = () => {
    ...
    const widgetUrl = `https://transferto.xyz/embed?integrator=aquaswap&fee=${FEE_PERCENTAGE}&toAddress=${ETH_FEE_WALLET}&theme=dark&logoUrl=${encodeURIComponent(window.location.origin + '/AquaSwap.svg')}&primaryColor=%234285F4&appearance=dark&hidePoweredBy=true`;
