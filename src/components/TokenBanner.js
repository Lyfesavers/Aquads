...
const TokenBanner = () => {
  ...
  return (
    <div className="relative h-12 bg-gray-800 border-y border-blue-500/20">
      ...
      <div className="flex items-center h-full overflow-hidden relative z-[0] pointer-events-none">
        <div className="flex animate-scroll whitespace-nowrap pointer-events-auto">
