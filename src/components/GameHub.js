            ...
            {games.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700 hover:border-blue-500 transition-all duration-300 flex flex-col h-full">
                  <div className="relative w-full h-48 bg-green-900 flex items-center justify-center">
                    <span style={{fontSize: '3rem'}}>🐎🏁</span>
                  </div>
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <h2 className="text-xl font-bold mb-2 text-yellow-400">Horse Racing</h2>
                      <p className="text-gray-300 mb-4">Bet your affiliate points and race against the house! Pick 1 of 10 horses. Win big if your horse wins!</p>
                    </div>
                    <a
