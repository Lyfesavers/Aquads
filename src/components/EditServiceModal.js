        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 shadow-lg">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-indigo-100 text-sm mt-1">Update your professional service listing</p>
            </div>
            <button 
              onClick={onClose} 
                  ...
                  <div className="bg-amber-900/20 border border-amber-500/30 rounded-lg p-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-amber-200 text-xs">Describe what information, files, or specifications you need from buyers to start the work.</p>
                      </div>
                    </div>
                  </div>
                </div>
