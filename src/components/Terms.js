          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 space-y-4">
                ...
                <p><span className="text-blue-400 font-semibold">9.5 Right to Investigate & Act.</span> Aquads reserves the right to monitor user activity, investigate suspicious behavior, and take any action deemed necessary to protect platform integrity. This includes but is not limited to: reviewing account activity patterns, analyzing referral networks, auditing point accumulation, and coordinating with fraud detection systems. By using the platform, you consent to such monitoring and agree that Aquads may act upon its findings at its sole discretion.</p>
              </div>
            </section>
