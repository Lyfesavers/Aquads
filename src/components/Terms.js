          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 space-y-4">
                ...
                <p><span className="text-blue-400 font-semibold">3.4 Effect on Escrow.</span> If your account is <span className="text-blue-400 font-semibold">terminated</span>, any funds you have in escrow at that time may be forfeited; we will not release them to you or to the other party except as we determine in accordance with our internal policy or applicable law. You will have no claim to such funds. If your account is <span className="text-blue-400 font-semibold">suspended</span>, we will hold any escrowed funds until the suspension is lifted and will not release them to the other party during the suspension; once the suspension is lifted, normal escrow release or refund rules apply.</p>
              </div>
            </section>
