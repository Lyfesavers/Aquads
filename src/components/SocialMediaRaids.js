...
const SocialMediaRaids = ({ currentUser, showNotification }) => {
  ...
  // Easter egg hook
  const { showEasterEgg, closeEasterEgg, checkEasterEggEligibility } = useEasterEgg(currentUser, pointsData);
  ...
  return (
    <div className="social-media-raids p-4">
      {/* Show Easter Egg if eligible */}
