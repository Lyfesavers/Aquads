...
const AquaSwap = ({
  ...
  const getChainForBlockchain = (blockchain) => {
    ...
    const mappedChain = chainMap[normalizedBlockchain] || normalizedBlockchain || 'ether';
    ...
    <div className="aquaswap-page">
          ...
          {!isSwapCollapsed && (
            <>
              ...
              <div className="swap-footer">
                ...
                <p className="swap-points-note">🎯 Earn 5 points per qualifying swap (minimum $5 USD notional).</p>
              </div>
        ...
        <div className="aquaswap-vote-fab" role="group" aria-label={`Vote on ${selectedProject.title}`}>
          ...
          <div className="aquaswap-vote-fab-actions">
            <button
              ...
              title="1 point once per bubble on your first vote; you can change anytime."
            >
      ...
      <ShillTemplatesModal
        ...
        tokenData={(() => {
          ...
          return {
            name: selectedProject?.title || activeTokenName || 'Token',
