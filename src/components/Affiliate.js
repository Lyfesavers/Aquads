          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800 rounded-lg p-8 shadow-lg mb-8">
              ...
              <ul className="space-y-4 text-gray-300">
                ...
                <li className="flex items-center space-x-2">
                  <span className="text-green-400">•</span>
                  <span>5% off the $99 Premium listing fee only (not Mintfunnel PR add-ons)</span>
                </li>
              </ul>
            </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-2">
                          <span className="text-green-400">💵</span>
                          <div>
                            <span className="text-gray-300">$100 CAD</span>
                            <p className="text-xs text-gray-400 mt-0.5">Paid out in any crypto desired</p>
                          </div>
                        </div>
