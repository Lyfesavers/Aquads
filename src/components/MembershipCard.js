  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <motion.div
        ...
        className="bg-gradient-to-br from-blue-900/90 to-purple-900/90 backdrop-blur-sm rounded-2xl p-6 max-w-md w-full border border-blue-500/30"
      >
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <div className="p-2 bg-blue-600/20 rounded-lg">
              <FaCrown className="text-blue-400 text-xl" />
            </div>
            <div>
              <h2 className="text-white text-xl font-bold">Aquads Membership</h2>
              <p className="text-blue-300 text-sm">Premium Partner Access</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Membership Card */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 mb-6 relative overflow-hidden">
          {/* Background Pattern */}
        ...
        {showQR && (
          ...
          >
            <div className="text-center">
              <div className="text-white/80 text-sm mb-2">Scan for Partner Verification</div>
              <div className="bg-white p-4 rounded-lg inline-block">
                {/* Simple QR Code representation - in production, use a proper QR library */}
                <div className="w-32 h-32 bg-black grid grid-cols-8 gap-1">
