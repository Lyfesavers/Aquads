...
const FeaturesCarousel = ({ features }) => {
  ...
  return (
    ...
    >
      ...
      {/* Navigation dots */}
      <div className="flex justify-center gap-2 -mt-30 mb-0">
    ...
    case 'On-Chain Resume':
      return (
        <svg {...svgProps} xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="60" y="48" fontSize="18" fill="#10b981" textAnchor="middle" fontWeight="700">88</text>
          <text x="60" y="62" fontSize="7" fill="#cbd5e1" textAnchor="middle">Trust Score</text>
          
          {/* Blockchain Badge */}
          <rect x="110" y="25" width="80" height="20" rx="3" fill="rgba(59, 130, 246, 0.2)" stroke="rgba(59, 130, 246, 0.4)" strokeWidth="1"/>
          <text x="150" y="37" fontSize="8" fill="#3b82f6" textAnchor="middle" fontWeight="600">⛓️ Base Chain</text>
          
          {/* Skills Badges */}
          <rect x="110" y="50" width="35" height="15" rx="2" fill="rgba(16, 185, 129, 0.2)"/>
          <text x="127.5" y="60" fontSize="6" fill="#10b981" textAnchor="middle">React</text>
          <rect x="150" y="50" width="35" height="15" rx="2" fill="rgba(16, 185, 129, 0.2)"/>
          <text x="167.5" y="60" fontSize="6" fill="#10b981" textAnchor="middle">Web3</text>
          <rect x="190" y="50" width="35" height="15" rx="2" fill="rgba(16, 185, 129, 0.2)"/>
          <text x="207.5" y="60" fontSize="6" fill="#10b981" textAnchor="middle">Solidity</text>
          
          {/* Verification Status */}
          <rect x="110" y="75" width="120" height="20" rx="3" fill="rgba(16, 185, 129, 0.2)" stroke="rgba(16, 185, 129, 0.4)" strokeWidth="1"/>
          <text x="170" y="87" fontSize="8" fill="#10b981" textAnchor="middle" fontWeight="600">✓ Verified On-Chain</text>
          
          {/* EAS Badge */}
          <rect x="110" y="100" width="120" height="25" rx="4" fill="rgba(59, 130, 246, 0.2)" stroke="rgba(59, 130, 246, 0.4)" strokeWidth="1.5"/>
          <text x="170" y="116" fontSize="9" fill="#3b82f6" textAnchor="middle" fontWeight="600">🔗 Ethereum Attestation</text>
        </svg>
      );
    ...
    <section className="relative w-full min-h-screen px-4 md:px-6 pt-4 md:pt-6 pb-2 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          {/* Content */}
          <div className="relative p-3 md:p-6 flex flex-col lg:flex-row items-center gap-4 lg:gap-6">
            {/* Left content */}
