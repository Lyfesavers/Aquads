          ...
          {JSON.stringify({
            ...
            "offers": [
              ...
              },
              {
                ...
                "price": "99",
                "priceCurrency": "USD",
                "description": "Paid listing with in-house blog and press release on Aquads, 1-hour fast-track review, 7-day homepage banner, AMA, and Skipper AI credit. Optional Mintfunnel distribution add-ons start at $284."
              }
            ],
            "featureList": [
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <>
              ...
              />
              <motion.div
                className="md:hidden absolute top-full left-0 right-0 mt-2 mx-4 z-[9999] max-h-[80vh] flex flex-col"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-5 md:gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-1 md:gap-6">
              ...
              <Link to="/docs" className="text-gray-500 hover:text-white text-xs md:text-sm transition-colors px-3 py-2 rounded-lg hover:bg-white/5">
                Documentation
              </Link>
            </div>
