...
const VOTE_BOOST_PACKAGES = [
  ...
  { 
    ...
    discountPercent: 20,
    description: '500 bullish votes - 20% OFF'
  },
  { 
    id: 'pro',
    name: 'Pro', 
    ...
    discountPercent: 30,
    description: '1,000 bullish votes - 30% OFF'
  },
  { 
    id: 'enterprise',
    name: 'Enterprise', 
    votes: 5000, 
    price: 599, 
    originalPrice: 1000, // Would be $1000 at base rate
    discountPercent: 40,
    description: '5,000 bullish votes - 40% OFF'
  }
];
