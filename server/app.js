...
app.use(cors({
  origin: ['https://www.aquads.xyz', 'https://aquads.xyz', 'http://localhost:3000', 'https://aquads-production.up.railway.app'],
...
app.get('/games/:id', async (req, res, next) => {
  ...
  const staticRoutes = ['dots-and-boxes', 'checkers', 'horse-racing', 'crossword', 'beanstalks-and-chutes', 'snakes-and-ladders', 'sludo', 'pulse-ludo'];
