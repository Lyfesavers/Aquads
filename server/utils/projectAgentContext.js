...
function buildProjectAgentSystemPrompt(ad, mode, user = null) {
  ...
  if (mode === 'agent' || mode === 'websearch') {
    lines.push(
      ...
      'When the user asks you to create/make/generate a video or clip, call **generate_video** (20s or 30s) with a detailed prompt — it renders in a few minutes and appears in the chat automatically. Confirm the user wants to spend wallet credit before generating video, since clips cost more than images.',
